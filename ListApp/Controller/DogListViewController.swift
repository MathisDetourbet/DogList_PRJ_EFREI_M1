...
extension DogListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let dogDetailViewControllerIdentifier = "idDogDetailsViewController"
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let viewController = storyboard.instantiateViewController(withIdentifier: dogDetailViewControllerIdentifier)
        
        if let dogDetailsViewController = viewController as? DogDetailsViewController {
